...
func NewEventsEnricherAPI(spec *loads.Document) *EventsEnricherAPI {
	return &EventsEnricherAPI{
		...
		ProduceEventsHandler: ProduceEventsHandlerFunc(func(params ProduceEventsParams) middleware.Responder {
			return middleware.NotImplemented("operation ProduceEvents has not yet been implemented")
		}),
	}
}
...
func (o *EventsEnricherAPI) Validate() error {
	...
	if o.ProduceEventsHandler == nil {
		unregistered = append(unregistered, "ProduceEventsHandler")
	}
...
func (o *EventsEnricherAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/v1/events/produce"] = NewProduceEvents(o.context, o.ProduceEventsHandler)
}
